    ...
    return(
        <div className="DescriptionText">
            <h1>Bem-vindo à nossa Locadora de Filmes Online, onde a magia do cinema encontra a conveniência do streaming!</h1>
                <p color={"#000"}>Explore um vasto catálogo de filmes que abrange desde clássicos intemporais até os lançamentos mais recentes,<br/>
                tudo na ponsta dos seus dedos. Desfrute da emoção de uma noite de cinema sem sair de casa, escolhendo entre uma variedade de gêneros e descobrindo novos favoritos a cada clique.<br/>
